...
*/
    ...
    public XSSFWorkbook generateSheet(XSSFWorkbook workbook, AbstractFunction func) {
        ...
        String sheetName = func.name() + ",n=" + func.spaceSize + ",Bin";
        String globalSheetName = func.name() + ",n=" + func.spaceSize + ",Bin, Global";
       ...
       /*GLOBAL*/
        ...
        for ( AlgorithmConfig    a:config){
            ...
            globalcell52.setCellValue("Бінарне");
            ...
            BinaryAlgorithmRunner runner = new BinaryAlgorithmRunner(func, a.populationSize, a.neighbourhoodSize, a.epsSize,a.changeSpeed);
